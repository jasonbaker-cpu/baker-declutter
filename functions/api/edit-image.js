...
async function handle(context) {
  ...
  // OpenAI image-edit calls take 60–120s. Holding the client HTTP
  // request open that long causes Cloudflare to drop the connection
  // with "Network connection lost". Instead, kick the slow work off
  // in the background via waitUntil and return immediately. The client
  // polls /api/batch?id=… to discover when each item completes.
